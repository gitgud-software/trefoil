...
CC_TGT_F = ['-c', '-o']
CC_VERSION = ('4', '7', '2')
CFLAGS = ['-mcpu=cortex-m3', '-mthumb', '-ffunction-sections', '-fdata-sections', '-g', '-Os', '-Wall', '-Wextra', '-Werror', '-Wno-unused-parameter', '-Wno-error=unused-function', '-Wno-error=unused-variable', '-std=c11', '-fms-extensions', '-Wno-address', '-Wno-type-limits', '-Wno-missing-field-initializers']
...
PBW_BIN_DIR = ''
PEBBLE_SDK = '/home/hackallofit/pebble-dev/PebbleSDK-3.4/Pebble/aplite'
PEBBLE_SDK_COMMON = '/home/hackallofit/pebble-dev/PebbleSDK-3.4/Pebble/common'
